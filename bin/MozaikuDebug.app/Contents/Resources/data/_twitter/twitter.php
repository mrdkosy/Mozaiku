<?php
    ...
    // 設定項目
    $api_key = 'haJMnw1IDXqsr8B6I6D9IUWSp';// APIキー
    $api_secret = '4JtgsKs6x2exaUTNRHbTjsE5D9WV9D5MhL75TUYqYYojRMOaed';// APIシークレット
...
//    $html .= '<h2>取得したデータ</h2>' ;
//    $html .= '<p>下記のデータを取得できました。</p>' ;
    $html .= 	'<h3>ボディ(JSON)</h3><br>' ;
    $html .= 	'<p><textarea rows="8">' . $json . '</textarea></p>' ;
    $html .= 	'<h3>レスポンスヘッダー</h3><br>' ;
    $html .= 	'<p><textarea rows="8">' . $header . '</textarea></p>' ;
